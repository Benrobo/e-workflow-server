...
export const getUsersById = router.post(API_ROUTE.getUsersById, checkAuth, async (req, res) => {
    try {
        let data = req.body;
        ...
        if (Object.entries(data).length === 0) {
            return util.sendJson(res, { error: true, message: "getting of users required a valid payload but got none" }, 404)
        }
